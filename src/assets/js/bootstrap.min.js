...
!(function (t, e) {
  ...
  class lt extends M {
    ...
    _getConfig(t) {
      if (
        ((t = { ...this.constructor.Default, ...$.getDataAttributes(this._element), ...t }),
  ...
  class _t extends M {
    ...
    _getConfig(t) {
      return (
        (t = { ...pt, ...$.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }),
        d('offcanvas', t, mt),
        t
      )
    }
  ...
  class St extends M {
    ...
    show() {
      ...
      ;(w.set(o, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) ||
          (d.appendChild(o), P.trigger(this._element, this.constructor.Event.INSERTED)),
        this._popper
          ? this._popper.update()
          : (this._popper = s.createPopper(this._element, o, this._getPopperConfig(c))),
    ...
    hide() {
      ...
      if (!P.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented) {
        if (
          ...
          'ontouchstart' in document.documentElement &&
            [].concat(...document.body.children).forEach((t) => P.off(t, 'mouseover', p)),
    ...
    setElementContent(t, e) {
      if (null !== t)
        return 'object' == typeof e && c(e)
          ...
          : void (this.config.html
              ? (this.config.sanitize && (e = Et(e, this.config.allowList, this.config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e))
    }
    getTitle() {
    ...
    _setListeners() {
      ;(this.config.trigger.split(' ').forEach((t) => {
        if ('click' === t)
          P.on(this._element, this.constructor.Event.CLICK, this.config.selector, (t) =>
            this.toggle(t),
          )
        else if ('manual' !== t) {
          const e =
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          ...
          (e || ((e = new jt(this, s)), w.set(this, 'bs.popover', e)), 'string' == typeof t)
        ) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`)
          e[t]()
        }
  ...
  class Ht extends M {
    ...
    _getConfig(t) {
      if (
        'string' != typeof (t = { ...Pt, ...('object' == typeof t && t ? t : {}) }).target &&
        c(t.target)
      ) {
        let { id: e } = t.target
    ...
    _activate(t) {
      ...
      ;(s.classList.contains('dropdown-item')
        ? (U.findOne('.dropdown-toggle', s.closest('.dropdown')).classList.add('active'),
    ...
    _transitionComplete(t, e, s) {
      ...
      ;(t.classList.add('active'),
        ...
        t.parentNode &&
          ...
          (t.closest('.dropdown') &&
            U.find('.dropdown-toggle').forEach((t) => t.classList.add('active')),
